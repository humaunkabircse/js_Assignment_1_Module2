...
//     const extractedValues = {name, age, index0, index2 };
...
// console.log(destructureExample(myObject, myArray));


// function destructureExample(myObject, myArray) {
//     const { name, age } = myObject;
//     const [index0, , index2] = myArray;
...
//   console.log(destructureExample(myObject));
...
// Convert the following function to an arrow function:
    const multiply = (a, b) => a * b; // assign value 5 , 6 
    console.log("[Exercise 5] OutPut: ", multiply(5, 6)); // Output 30
...
//    return num1 > num2 ? "Learger" : "small";
// }
